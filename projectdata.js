...
const data = {
	lg: [
		...
		{
			type: 'p',
			content: 'LG Wonderbox Showcase Challenge 2023 is a competition that invites creators to submit a 3D billboard for a chance to win a cash prize, and a trip to see it in person, displayed in Times Square. Little did we know when we started this project, that we would be one of 3 finalists that got onto the billboard, and a special apparenance on the Drew Barrymore Show.',
		},
	...
	drifting: [
		...
		{
			type: 'p',
			content: "We had the opportunity to bring our VFX magic and our love for sci-fi together in 'Drifting'. A mini-series directed by Elliot Walker, Driting required CG and VFX work ranging from video effects like teleportation, all the way to full 3D built and rendered scenes.",
		},
		{
			type: 'p',
			desc: true,
	...
	max: [
		...
		{
			type: 'p',
			content: 'Working with the streaming platform, Max (formerly HBO Max), and popular TikTok creator, Elliott Walker, Scene was hired as the sole VFX studio for a short-form promo. Through our work, viewers are transported to the worlds of Dune and Jurassic World.',
		},
	...
	paxahauMetroTimes: [
		...
		{
			type: 'p',
			content: 'Scene was approached by Paxahau to create a cover for Movement, an electronic music festival in the heart of Detroit city. The cover was featured in Metro Times, a local Detroit publication.',
		},
